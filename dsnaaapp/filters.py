...
class   DocFilter(django_filters.FilterSet):
    pays = django_filters.ChoiceFilter(choices=pays)
    type_de_doc = django_filters.ChoiceFilter(choices=types)
    language = django_filters.ChoiceFilter(choices = lan)

    class Meta:
        model = Documents
        fields = ["titre","autheur","mot_cle","pays","language"]

class   LibFilter(django_filters.FilterSet):
